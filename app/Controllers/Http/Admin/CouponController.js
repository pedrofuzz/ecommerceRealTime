...
class CouponController {
  ...
  async store({ request, response }) {
     ...
     * 2 - cliente - poder ser utilizado apenas por clientes específicos
     * 3 - cliente e produto - pode ser utilizado somente em produtos específicos por clientes específicos
    ...
    try {
      ...
      return response.status(400).send({
        message: 'Não foi possível criar o cupom, tente novamente'
      })
    }
  }
  ...
  async update({ params: { id }, request, response }) {
    ...
    try {
      ...
      await trx.rollback()
      return response.status(400).send({
        message: 'Não foi possível atualizar o cupom, tente novamente'
      })
    }
  }
  ...
  async destroy({ params: { id }, request, response }) {
    ...
    try {
      ...
      await trx.rollback()
      return response.status(400).send({
        message: 'Não foi possível deletar este cupom, tente novamente'
      })
    }
  }
}
